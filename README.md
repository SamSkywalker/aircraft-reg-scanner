...
4. Also use `streamlit run db_manager_ui.py` to run independent UI for database management system
...
3. 运行 `main.py` 或者使用 `streamlit run app_ui.py` 访问测试版UI
4. 亦可使用 `streamlit run db_manager_ui.py` 访问数据库查询编辑系统的独立UI
...
UPD @ 2026/6/22:Ver 0.4a 加入了数据库管理模块和独立的UI界面;作为修改测试,更新了B-2813为邮航,B-1200已备注彩绘;注:数据库查询系统目前独立运行,暂未整合到识别系统中
